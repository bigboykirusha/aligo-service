   ...
   <div class="number-input">
      ...
      <div class="number-input__block">
         <div class="number-input__wrapper">
            <input
               v-model="optionValue"
               v-mask="{ mask: 'Y ### YY | ###', tokens: customTokens }"
               type="text"
            ...
            <img
               ...
               :src="closeIcon"
               alt="Clear"
               class="number-input__clear"
               @click="clearInput"
            >
         </div>
         <div
            v-if="hasInput && hasBlurred && isErrorDisplayed"
            :class="{
               'number-input__error': !isValid,
               'number-input__success': isValid
            }"
         >
...
const errorMessage = computed(
   () => 'Госномер должен соответствовать формату: А 123 ВС 45'
)
