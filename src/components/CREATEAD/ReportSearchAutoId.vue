         ...
         <div class="report-search__popup-content">
            ...
            <div v-if="formattedResult" class="report-search__fields">
               ...
               <div class="report-search__field">
                  ...
                  <span class="report-search__value">{{ formattedResult.mileage }} </span>
               </div>
               <div class="report-search__field">
...
const validRegions = new Set([
   ...
   "17", "18", "19", "21", "121", "22", "23", "93", "123", "193", "24", "84", "88", "124", "25", "125", "26", "126", "27", "28", "29",
   "30", "31", "32", "33", "34", "134", "35", "36", "136", "37", "38", "85", "138", "39", "91", "40", "41", "42", "142", "43", "44",
   "45", "46", "47", "147", "48", "49", "50", "90", "150", "190", "750", "790", "51", "52", "152", "53", "54", "154", "55", "56",
   "57", "58", "59", "81", "159", "60", "61", "161", "761", "62", "63", "163", "763", "64", "164", "65", "66", "96", "196", "67", "68",
   "69", "70", "71", "72", "73", "173", "174", "774", "75", "80", "76", "77", "97", "99", "177", "197", "199", "777", "799", "797",
   "78", "98", "178", "198", "79", "82", "83", "86", "186", "87", "89"
]);
   ...
   if (Array.isArray(result.value.data) && result.value.data[0]) {
      ...
      return {
         ...
         mileage: ad.auto_history_conditions?.[0]?.mileage
            ? `${ad.auto_history_conditions[0].mileage} км`
            : "—",
         price: ad.ads_parameter?.amount
            ? `${ad.ads_parameter.amount} ₽`
            : "—",
